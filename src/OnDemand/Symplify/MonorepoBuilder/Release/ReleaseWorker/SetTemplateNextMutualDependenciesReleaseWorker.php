...
final class SetTemplateNextMutualDependenciesReleaseWorker extends AbstractSetNextMutualDependenciesReleaseWorker
{
    ...
    public function getDescription(Version $version): string
    {
        ...
        return sprintf('[Operate on templates] Set packages mutual dependencies to "%s" (alias of dev version)', $versionInString);
    }
}
