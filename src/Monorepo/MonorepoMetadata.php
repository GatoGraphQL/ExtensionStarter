...
{
    /**
     * @gatographql-extension This is the version used by all packages and plugins
    ...
    /**
     * @gatographql-extension This is needed to generate the "dev-main" alias
    ...
    /**
     * @gatographql-extension Git user to use when doing a "monorepo split".
     */
    final public const GIT_USER_NAME = 'leoloso';

    /**
     * @gatographql-extension Git email to use when doing a "monorepo split".
     */
    final public const GIT_USER_EMAIL = 'leo@getpop.org';

    /**
     * @gatographql-extension GitHub organization account hosting this project,
    ...
    /**
     * @gatographql-extension GitHub repo name hosting this project,
     *                        as to point there to retrieve images for the plugin
