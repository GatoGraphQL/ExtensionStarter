...
use PoP\ExtensionStarter\OnDemand\Symplify\MonorepoBuilder\ModifyProject\CreateExtensionWorker\UpdateMonorepoMergeMonorepoConfigCreateExtensionWorker;
...
class CreateExtensionWorkersDataSource
{
    ...
    public function getCreateExtensionWorkerClasses(): array
    {
        return [
            ...
            UpdateMonorepoMergeMonorepoConfigCreateExtensionWorker::class,
        ];
    }
}
